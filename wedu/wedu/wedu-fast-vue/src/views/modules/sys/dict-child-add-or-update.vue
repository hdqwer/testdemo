  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="字典编码" prop="code">
        <el-input v-model="dataForm.code" placeholder="字典编码" disabled></el-input>
      </el-form-item>
      <el-form-item label="字典项" prop="name">
        <el-input v-model="dataForm.name" placeholder="字典项"></el-input>
      </el-form-item>
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                this.$message({
                  ...
                  onClose: () => {
                    this.visible = false
                    this.$emit('refreshChildDataList', this.dataForm.code)
                  }
                })
              } else {
