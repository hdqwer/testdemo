...
;(function() {
  var resList = {
    ...
    js: [
      ...
      window.SITE_CONFIG.cdnUrl + '/static/plugins/echarts-5.3.3/echarts.js',
      // window.SITE_CONFIG.cdnUrl + '/static/plugins/echarts-5.3.3/lib/chart/gauge/GaugeSeries.js',
      // window.SITE_CONFIG.cdnUrl + '/static/plugins/echarts-5.3.3/lib/chart/gauge/GaugeView.js',
      // 插件 - ueditor
